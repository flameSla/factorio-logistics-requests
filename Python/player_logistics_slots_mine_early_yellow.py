...
out='player_logistics_slots_mine_early_yellow.python.lua'
...
files.add_to_file_and_set_filters( out, 'src\player_logistics_slots_mine_early.h')
files.add_to_file_and_set_filters( out, 'src\player_logistics_slots_mine_early_yellow.cfg')
