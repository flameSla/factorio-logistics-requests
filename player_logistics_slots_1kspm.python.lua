...
s( 102, {max = 150, min = 150, name = "electric-mining-drill"})
...
s( 121, {max = 20, min = 20, name = "beacon"})
s( 124, {max = 450, min = 450, name = "speed-module-3"})
...
for k = 1, 2 do
    i.set_filter(ii, "beacon"); ii = ii - 1; i.sort_and_merge();
end;
for k = 1, 9 do
