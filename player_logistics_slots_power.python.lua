...
for k = 1, 3 do
    i.set_filter(ii, "heat-exchanger"); ii = ii - 1; i.sort_and_merge();
end;
i.set_filter(ii, "pipe"); ii = ii - 1; i.sort_and_merge();
for k = 1, 4 do
    i.set_filter(ii, "heat-pipe"); ii = ii - 1; i.sort_and_merge();
end;
...
i.set_filter(ii, "nuclear-reactor"); ii = ii - 1; i.sort_and_merge();
