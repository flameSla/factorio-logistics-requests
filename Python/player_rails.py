...
files.add_to_file_and_set_filters( out, 'src\player_rails.cfg')
files.add_to_file( out, 'src\player_a_common_part_for_all_configurations.h')
files.add_text_to_file( out, 's( 87, {max = 40, min = 40, name = "cliff-explosives"})')
